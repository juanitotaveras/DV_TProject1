...
This Visualization provides useful insight into the large change in public opinion after 2007 that likely occured due to the Great Recession. After 2007, public opinion is less and less concerned with defense and far more concerned with macroeconomics. The importance of macroeconomics became far more important to the public once the negative effects of the recession reached its low point. Our KPI is calculated to determine how important a topic is based on the percentage for that year.
