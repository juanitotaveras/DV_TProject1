...
##Data Blending
We blended our original dataset with a Dataset on Public Laws passed by the United States Congress. Here is a tableau visualization of the blended datasets. The two datasets are identical by year and major topic.The text in the crosstab is set to the id number of the law passed. The color is based on a KPI for topic importance at the time of the law's passing.
![](../02 Tableau/DataBlending1.jpg)

We made another dataset called Policy Moods and randomized the percentages of people's opinions on major topics using a Python script. We then blended it with our original dataset and made this scatterplot with it, which is the same as our scatterplot about Social Issues 1960 - 2012 but with this additional data.
