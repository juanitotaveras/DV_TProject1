...
Since our two datasets only had discrete variables in common, which were Year and MajorTopic, it was not possible to plot a table in R. Join would be a better function for this.
But here is a table of the data sources blended with these two columns.
